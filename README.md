...
- ['Compound components' via child functions - tabs UI via procedurally inter-dependent components](https://github.com/MithrilJS/mithril.js/issues/2148#issuecomment-393279589)

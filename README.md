...
[<img src="https://mithril.js.org/logo.svg" align="right" width="100" alt="Mithril logo">](https://mithril.js.org)

> A curated list of Mithril libraries, utilities, and other awesome
...
- [Testing](#testing)
- [Libraries, Components, and Plugins](#libraries-components-and-plugins)
- [Tools](#tools)
- [Pre-1.0 Resources](#pre-10-Resources)
- [License](#license)
...
- [Mithril tutorial app](https://github.com/spacejack/mithril-tutorial-ts) - The tutorial app from Mithril's website, adapted to Typescript.
...
- [Lichess's mobile app](https://lichess.org/mobile) - Mobile version for Lichess using Mithril inside Cordova.
...
- [mithril-sass-webpack-starter](https://github.com/CreaturesInUnitards/mithril-sass-webpack-starter) - Starter project set up with Mithril, Sass, and Webpack 2
- [Mithril / Webpack / Typescript / Sass Example](https://github.com/spacejack/mithril-webpack-ts) - Starter project set up with Mithril, Typescript 2, and Webpack 2 with options for Sass, PostCSS, or both.
- [Mithril / Typescript / Browserify / HMR / Budō](https://github.com/spacejack/mithril-browserify-ts-budo) - Starter project set up with Mithril, Typescript, PostCSS, Browserify with hot module replacement, and Budō.
- [THREE / Mithril / Typescript starter project](https://github.com/spacejack/three-mithril-ts) - Starter project for game development, set up with Mithril, three.js, and Typescript.
- [mithril-starter-rollup](https://github.com/ArthurClemens/mithril-starter-rollup) - Starter project set up with Mithril, Rollup, Babel, LiveReload, Jest, and ESLint, with Tachyon support built-in.
- [Mithril Starter Kit](https://github.com/dhinesh03/mithril-starter-kit) - A boilerplate project set up with Mithril, Babel, Webpack 4 with hot reload support, Sass/SCSS, and ESLint.

### Testing

Mithril does not require specialized tools for testing with most frameworks, but the following have been developed as side projects to the main framework and/or by the community.

- [ospec](https://github.com/MithrilJS/mithril.js/tree/next/ospec) - Mithril's own fast test runner.
- [Mithril Query](https://github.com/MithrilJS/mithril-query) - Query Mithril's virtual dom for testing purposes.
- [mithril-jest](https://github.com/ArthurClemens/mithril-jest) - Integrates Mithril with Jest, particularly its built-in snapshot functionality.

### Libraries, Components, and Plugins
...
- [Mithril Template Converter](https://arthurclemens.github.io/mithril-template-converter/) - Convert HTML to calls to `m()`.
...
- [Leo's Blog](http://lhorie.github.io/mithril-blog/) - Leo, the original author of Mithril, wrote about the virtual DOM and various tips and tricks surrounding it.
- [Mithril's wiki](https://github.com/MithrilJS/mithril.js/wiki) - Mostly about utilities written in the days of v0.1 and v0.2, but some material may be more up to date with the current API.
